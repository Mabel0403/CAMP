...
class Configuration:
    def __init__(self):
        ...
        parser.add_argument('--ckpt_path',
                            default='/media/mabel/checkpoints/university/001_important_model/0.9446_pt/weights_e1_0.9446.pth',
...
if config.dataset == 'U1652-D2S':
    config.query_folder_train = f'./data/{config.dataset_name}/train/satellite'
    config.gallery_folder_train = f'./data/{config.dataset_name}/train/drone'
    config.query_folder_test = f'./data/{config.dataset_name}/test/query_drone'
    config.gallery_folder_test = f'./data/{config.dataset_name}/test/gallery_satellite'
elif config.dataset == 'U1652-S2D':
    config.query_folder_train = f'./data/{config.dataset_name}/train/satellite'
    config.gallery_folder_train = f'./data/{config.dataset_name}/train/drone'
    config.query_folder_test = f'./data/{config.dataset_name}/test/query_satellite'
    config.gallery_folder_test = f'./data/{config.dataset_name}/test/gallery_drone'
